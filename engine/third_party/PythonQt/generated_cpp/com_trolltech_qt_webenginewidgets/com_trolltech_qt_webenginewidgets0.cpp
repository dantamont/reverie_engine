...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      bool returnValue{};
      void* args[4] = {NULL, (void*)&url0, (void*)&type1, (void*)&isMainFrame2};
...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      bool returnValue{};
      void* args[2] = {NULL, (void*)&certificateError0};
      PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
      if (result) {
        args[0] = PythonQtConv::ConvertPythonToQt(methodInfo->parameters().at(0), result, false, NULL, &returnValue);
        if (args[0]!=&returnValue) {
...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      void* args[4] = {NULL, (void*)&mode0, (void*)&oldFiles1, (void*)&acceptedMimeTypes2};
      PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
      if (result) {
        args[0] = PythonQtConv::ConvertPythonToQt(methodInfo->parameters().at(0), result, false, NULL, &returnValue);
        if (args[0]!=&returnValue) {
...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromArgumentList(3, argumentList);
      void* args[3] = {NULL, (void*)&securityOrigin0, (void*)&msg1};
      PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
      if (result) { Py_DECREF(result); } 
      Py_DECREF(obj);
      return;
...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      void* args[5] = {NULL, (void*)&level0, (void*)&message1, (void*)&lineNumber2, (void*)&sourceID3};
      PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
      if (result) { Py_DECREF(result); } 
      Py_DECREF(obj);
      return;
...
if (_wrapper) {
  ...
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    if (obj) {
      ...
      static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromArgumentList(5, argumentList);
      bool returnValue{};
      void* args[5] = {NULL, (void*)&securityOrigin0, (void*)&msg1, (void*)&defaultValue2, (void*)&result3};
      PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
      if (result) {
        args[0] = PythonQtConv::ConvertPythonToQt(methodInfo->parameters().at(0), result, false, NULL, &returnValue);
        if (args[0]!=&returnValue) {
