...
{
public:
    PythonQtShell_QWebEnginePage(QObject*  parent = NULL):QWebEnginePage(parent),_wrapper(NULL) {};
    PythonQtShell_QWebEnginePage(QWebEngineProfile*  profile, QObject*  parent = NULL):QWebEnginePage(profile, parent),_wrapper(NULL) {};

   ~PythonQtShell_QWebEnginePage();
...
public slots:
QWebEnginePage* new_QWebEnginePage(QObject*  parent = NULL);
QWebEnginePage* new_QWebEnginePage(QWebEngineProfile*  profile, QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QWebEngineProfile(QObject*  parent = NULL):QWebEngineProfile(parent),_wrapper(NULL) {};
    PythonQtShell_QWebEngineProfile(const QString&  name, QObject*  parent = NULL):QWebEngineProfile(name, parent),_wrapper(NULL) {};

   ~PythonQtShell_QWebEngineProfile();
...
public:
public slots:
QWebEngineProfile* new_QWebEngineProfile(QObject*  parent = NULL);
QWebEngineProfile* new_QWebEngineProfile(const QString&  name, QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QWebEngineUrlRequestInterceptor(QObject*  p = NULL):QWebEngineUrlRequestInterceptor(p),_wrapper(NULL) {};
...
public:
public slots:
QWebEngineUrlRequestInterceptor* new_QWebEngineUrlRequestInterceptor(QObject*  p = NULL);
...
{
public:
    PythonQtShell_QWebEngineUrlSchemeHandler(QObject*  parent = NULL):QWebEngineUrlSchemeHandler(parent),_wrapper(NULL) {};

   ~PythonQtShell_QWebEngineUrlSchemeHandler();

virtual void childEvent(QChildEvent*  event);
virtual void customEvent(QEvent*  event);
virtual bool  event(QEvent*  event);
virtual bool  eventFilter(QObject*  watched, QEvent*  event);
virtual void requestStarted(QWebEngineUrlRequestJob*  arg__1);
virtual void timerEvent(QTimerEvent*  event);
...
public:
public slots:
QWebEngineUrlSchemeHandler* new_QWebEngineUrlSchemeHandler(QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QWebEngineView(QWidget*  parent = NULL):QWebEngineView(parent),_wrapper(NULL) {};
...
public:
public slots:
QWebEngineView* new_QWebEngineView(QWidget*  parent = NULL);
