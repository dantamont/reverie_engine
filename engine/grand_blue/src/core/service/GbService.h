...
class AbstractService: public Gb::Object {
public:
    //-----------------------------------------------------------------------------------------------------------------
    ...
    virtual const char* namespaceName() const override { return "Gb::View::AbstractService"; }
    /// @}
...
public:
    ...
    virtual const char* namespaceName() const override { return "Gb::View::Service"; }
    /// @}
private:
    /// Private Methods
};
