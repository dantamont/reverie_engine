...
public:
    ...
    virtual void bindFrame(bool clear) = 0;
...
public:
    ...
    void widgetToWorldSpace(const Vector3& widgetSpace, Vector3& worldSpace) const;
    void worldToWidgetSpace(const Vector3& worldSpace, Vector3& widgetSpace) const;
