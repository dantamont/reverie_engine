...
#define VARIANT_MINIMIZE_SIZE
#define VARIANT_OPTIMIZE_FOR_SPEED
/////////////////////////////////////////////////////////////////////////////////////////////
// Includes
/////////////////////////////////////////////////////////////////////////////////////////////
// Standard
...
// Internal
#include "GbRecursiveWrapper.h"
#include "GbVariantVisitor.h"
...
# ifdef __GNUC__
#  define VARIANT_DEPRECATED __attribute__((deprecated))
# elif defined(_MSC_VER)
#  define VARIANT_DEPRECATED __declspec(deprecated)
# else
#  define VARIANT_DEPRECATED
# endif
#else
#  define VARIANT_DEPRECATED [[deprecated]]
#endif
...
#if !defined(VARIANT_MINIMIZE_SIZE)
using type_index_t = unsigned int;
#else
#if defined(VARIANT_OPTIMIZE_FOR_SPEED)
...
//struct direct_type_info;
//
//template <typename First, typename... Types>
//struct direct_type_info<First, Types...>
//{
//    static constexpr const type_info& info = 
//        std::is_same<T, First>::value
//        ? typeid(First)
//        : direct_type<T, Types...>::info;
//};
...
public:
    ...
    {
        new (&m_data) typename Traits::target_type(std::forward<T>(val));
    }

    VARIANT_INLINE Variant(Variant<Types...> const& old)
        : type_index(old.type_index)
    {
        helper_type::copy(old.type_index, &old.m_data, &m_data);
    }
    ...
    VARIANT_INLINE Variant(Variant<Types...>&& old)
        ...
        : type_index(old.type_index)
    {
        helper_type::move(old.type_index, &old.m_data, &m_data);
    }

private:
    VARIANT_INLINE void copy_assign(Variant<Types...> const& rhs)
    {
        helper_type::destroy(type_index, &m_data);
        type_index = detail::invalid_value;
        helper_type::copy(rhs.type_index, &rhs.m_data, &m_data);
    ...
    VARIANT_INLINE void move_assign(Variant<Types...>&& rhs)
    {
        helper_type::destroy(type_index, &m_data);
        type_index = detail::invalid_value;
        helper_type::move(rhs.type_index, &rhs.m_data, &m_data);
        type_index = rhs.type_index;
    }
...
public:
    ...
    // Obtain the type info of the variant
    const std::type_info& typeInfo() const {
        variant::ReflectVisitor visitor;
        return apply_visitor(visitor, *this);
    }

    // Obtain the data as a void pointer (for passing to buffers)
    ...
    // Whether or not the variant is of the specified type
    ...
    template <typename T, typename std::enable_if<
        ...
        VARIANT_INLINE T& get_unchecked()
    {
        return (*reinterpret_cast<recursive_wrapper<T>*>(&m_data)).get();
    }
    ...
    template <typename T, typename std::enable_if<
        ...
        VARIANT_INLINE T const& get_unchecked() const
    {
        return (*reinterpret_cast<recursive_wrapper<T> const*>(&m_data)).get();
    }
    ...
    template <typename T, typename std::enable_if<
        ...
        VARIANT_INLINE T& get_unchecked()
    {
        return (*reinterpret_cast<std::reference_wrapper<T>*>(&m_data)).get();
    }
    ...
    template <typename T, typename std::enable_if<
        ...
        VARIANT_INLINE T const& get_unchecked() const
    {
        return (*reinterpret_cast<std::reference_wrapper<T const> const*>(&m_data)).get();
    }
...
namespace std {
template <typename... Types>
struct hash<Gb::Variant<Types...>> {
    std::size_t operator()(const Gb::Variant<Types...>& v) const noexcept
    {
        return apply_visitor(variant::hasher{}, v);
    }
};
}
