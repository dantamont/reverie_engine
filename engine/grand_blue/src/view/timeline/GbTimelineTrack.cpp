...
///////////////////////////////////////////////////////////////////////////////////////////////////
void TimelineTrack::setText(const QString & text, bool isBold)
{
    if (!scene()) {
        throw("Error, need to add to scene before setting text");
    }
    ...
    if (m_isRowHeader) {
        if (m_textWidth > m_length) {
            ...
            emit ts->resizeRowHeaders(m_length);
        }
    }
}
///////////////////////////////////////////////////////////////////////////////////////////////////
