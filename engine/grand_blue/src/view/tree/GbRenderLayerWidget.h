...
public:
    ...
    virtual const char* namespaceName() const override { return "Gb::View:RenderLayerItem"; }
...
public:
    ...
    virtual const char* namespaceName() const override { return "Gb::View::RenderLayerTreeWidget"; }
