...
public:
    ...
    virtual const char* namespaceName() const override { return "Gb::View:AnimationItem"; }
...
public:
    ...
    virtual const char* namespaceName() const override { return "Gb::View::AnimationTreeWidget"; }
