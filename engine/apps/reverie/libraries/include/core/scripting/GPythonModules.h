...
PYBIND11_EMBEDDED_MODULE(reverie, m) {
    ...
    PyVector::PyInitialize<Real_t, 2>(m, "Vector2");
    PyVector::PyInitialize<Real_t, 3>(m, "Vector3");
    PyVector::PyInitialize<Real_t, 4>(m, "Vector4");
    PyMatrix::PyInitialize<Real_t, 2>(m, "Matrix2x2");
    PyMatrix::PyInitialize<Real_t, 3>(m, "Matrix3x3");
    PyMatrix::PyInitialize<Real_t, 4>(m, "Matrix4x4");
