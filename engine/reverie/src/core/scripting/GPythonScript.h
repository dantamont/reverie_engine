...
public:
    ...
    virtual ResourceType getResourceType() const override {
        return ResourceType::kPythonScript;
    }
    ...
    virtual const char* namespaceName() const { return "rev::PythonScript"; }
    /// @}
...
public:
    ...
    /// @property namespaceName
    virtual const char* namespaceName() const { return "rev::PythonClassScript"; }
    /// @}
