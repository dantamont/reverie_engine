...
public:
    ...
    static PolygonType typeFromName(const GString& name);

    /// @brief QStrings used to name shape meshes
    static std::array<GString, MAX_POLYGON_TYPE> s_polygonNames;
...
protected:
    ...
    static std::unique_ptr<Mesh> createRectangle(real_g height = 1.0f,
        real_g width = 1.0f,
        real_g z = -0.5f);
