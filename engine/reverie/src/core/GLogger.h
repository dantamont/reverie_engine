...
#include "../core/containers/GStringView.h"
...
public:
    ...
    static rev::VSConsoleLogHandler* getVSLogger(const GString& loggerName,
        LogLevel logLevel = LogLevel::Debug);

    /// @brief Create instance of console tool logger
    static rev::View::ConsoleTool* getConsoleTool(const GString& loggerName,
        LogLevel logLevel = LogLevel::Debug);
