...
class IKNode: public Object, public Identifiable {
public:
    ...
    virtual const char* namespaceName() const { return "rev::IKNode"; }
    /// @}
...
public:
    ...
    /// @property namespaceName
    virtual const char* namespaceName() const { return "rev::IKChain"; }
    /// @}
