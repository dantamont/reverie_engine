...
public:
    ...
    const char* namespaceName() const override { return "rev::ControllerDescription"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::BoxControllerDescription"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::CapsuleControllerDescription"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::CharacterController"; }
...
public:
    ...
    CharacterController* CreateController(const QJsonValue& json);
...
protected:
    ...
    /// @brief Vector of character controllers
    std::vector<std::unique_ptr<CharacterController>> m_controllers;
