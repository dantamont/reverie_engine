...
/////////////////////////////////////////////////////////////////////////////////////////////
QString FileReader::AbsolutePath(const char * root, const char * relPath)
{
    // See: https://forum.qt.io/topic/76590/relative-path-to-absolute-path
    QDir rootDir(root);
    QString absPath = rootDir.cleanPath(rootDir.absoluteFilePath(relPath));
    return absPath;
}
/////////////////////////////////////////////////////////////////////////////////////////////
QString FileReader::RelativePath(const char * root, const char * absPath)
{
    // See: https://forum.qt.io/topic/76590/relative-path-to-absolute-path
    QDir rootDir(root);
...
/////////////////////////////////////////////////////////////////////////////////////////////
QString FileReader::ReplaceExtension(const QString & fileName, const char * ext)
{
    QString newPath = fileName;
    GString extStr = GString(".") + ext;
    QString oldExt = FileExtension(fileName);
    newPath.replace("." + oldExt, extStr.c_str());
    return newPath;
}
/////////////////////////////////////////////////////////////////////////////////////////////
