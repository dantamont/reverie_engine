#include "GLightComponentWidget.h"
...
LightDirectionWidget::LightDirectionWidget(CoreEngine * core,
    ...
    m_lightComponent(light)
{
    m_lineEdits[0]->setMaximumWidth(0.5 * Viewport::ScreenDPIX());
    m_lineEdits[1]->setMaximumWidth(0.5 * Viewport::ScreenDPIX());
    m_lineEdits[2]->setMaximumWidth(0.5 * Viewport::ScreenDPIX());
}
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
void LightComponentWidget::initializeWidgets()
{
    ...
    m_minBias->setMaximumWidth(0.75 * Viewport::ScreenDPIX());
    ...
    m_maxBias->setMaximumWidth(0.75 * Viewport::ScreenDPIX());
    ...
    m_lightIntensity->setMaximumWidth(0.75 * Viewport::ScreenDPIX());
    ...
    m_lightRange->setMaximumWidth(0.75 * Viewport::ScreenDPIX());
