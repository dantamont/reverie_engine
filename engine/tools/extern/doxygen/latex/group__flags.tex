...
\DoxyCodeLine{\textcolor{keyword}{inline} \textcolor{keyword}{const} Index* innerIndexPtr() \textcolor{keyword}{const};}
\DoxyCodeLine{\textcolor{keyword}{inline} \textcolor{keyword}{const} Index* outerIndexPtr() \textcolor{keyword}{const};}
\DoxyCodeLine{\textcolor{keyword}{inline} \textcolor{keyword}{const} Index* innerNonZeroPtr() \textcolor{keyword}{const};}
\end{DoxyCode}
...
\subsubsection{\texorpdfstring{LvalueBit}{LvalueBit}}
