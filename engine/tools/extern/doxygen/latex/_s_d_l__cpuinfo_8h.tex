\hypertarget{_s_d_l__cpuinfo_8h}{}\section{C\+:/\+Users/dante/\+Documents/\+Projects/grand-\/blue-\/engine/reverie/src/third\+\_\+party/\+S\+D\+L2/\+S\+D\+L\+\_\+cpuinfo.h File Reference}
\label{_s_d_l__cpuinfo_8h}\index{C:/Users/dante/Documents/Projects/grand-\/blue-\/engine/reverie/src/third\_party/SDL2/SDL\_cpuinfo.h@{C:/Users/dante/Documents/Projects/grand-\/blue-\/engine/reverie/src/third\_party/SDL2/SDL\_cpuinfo.h}}
...
\item 
D\+E\+C\+L\+S\+P\+EC S\+D\+L\+\_\+bool S\+D\+L\+C\+A\+LL \mbox{\hyperlink{_s_d_l__cpuinfo_8h_aa5356bc82108c60c3bee504ee63fda7e}{S\+D\+L\+\_\+\+Has\+A\+R\+M\+S\+I\+MD}} (void)
\item 
...
D\+E\+C\+L\+S\+P\+EC void $\ast$S\+D\+L\+C\+A\+LL \mbox{\hyperlink{_s_d_l__cpuinfo_8h_af533acf5c60f71bcefef0d8cea9dae99}{S\+D\+L\+\_\+\+S\+I\+M\+D\+Realloc}} (void $\ast$mem, const size\+\_\+t len)
\begin{DoxyCompactList}\small\item\em Reallocate memory obtained from S\+D\+L\+\_\+\+S\+I\+M\+D\+Alloc. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{class_c_p_u}{C\+PU}} feature detection for S\+DL. 
...
This function returns the L1 cache line size of the \mbox{\hyperlink{class_c_p_u}{C\+PU}}
...
This function returns the number of \mbox{\hyperlink{class_c_p_u}{C\+PU}} cores available. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_af672834675f296bed0e226113695bebd}\label{_s_d_l__cpuinfo_8h_af672834675f296bed0e226113695bebd}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has 3D\+Now! features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a9bc2024dc37b1d318eb197c161f8e50b}\label{_s_d_l__cpuinfo_8h_a9bc2024dc37b1d318eb197c161f8e50b}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has Alti\+Vec features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_aa5356bc82108c60c3bee504ee63fda7e}\label{_s_d_l__cpuinfo_8h_aa5356bc82108c60c3bee504ee63fda7e}} 
...
\subsubsection{\texorpdfstring{SDL\_HasARMSIMD()}{SDL\_HasARMSIMD()}}
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has A\+RM S\+I\+MD (A\+R\+Mv6) features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_aec739a6c622987314d9a22899c4ba673}\label{_s_d_l__cpuinfo_8h_aec739a6c622987314d9a22899c4ba673}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has A\+VX features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a1fa7d982a27fb5a29fc1b291fc1054f4}\label{_s_d_l__cpuinfo_8h_a1fa7d982a27fb5a29fc1b291fc1054f4}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has A\+V\+X2 features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a5108ee8d59a6d8a0a978f96b799bd3b1}\label{_s_d_l__cpuinfo_8h_a5108ee8d59a6d8a0a978f96b799bd3b1}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has A\+V\+X-\/512F (foundation) features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_aecec2f1434aa2eb5c82f974880f5181f}\label{_s_d_l__cpuinfo_8h_aecec2f1434aa2eb5c82f974880f5181f}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has M\+MX features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_ac5096ea77af07eb4a9d4c754289b2a2b}\label{_s_d_l__cpuinfo_8h_ac5096ea77af07eb4a9d4c754289b2a2b}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has N\+E\+ON (A\+RM S\+I\+MD) features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_afea666a39b6be7821303adcf16e83c47}\label{_s_d_l__cpuinfo_8h_afea666a39b6be7821303adcf16e83c47}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has the R\+D\+T\+SC instruction. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_aed4b71a601e3a12786a5280f59c0e26d}\label{_s_d_l__cpuinfo_8h_aed4b71a601e3a12786a5280f59c0e26d}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has S\+SE features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_aadc66ce3d29c669f6c78ee17c592336e}\label{_s_d_l__cpuinfo_8h_aadc66ce3d29c669f6c78ee17c592336e}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has S\+S\+E2 features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_ab0dfbc5d529ba0b65d1fff744da69f5e}\label{_s_d_l__cpuinfo_8h_ab0dfbc5d529ba0b65d1fff744da69f5e}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has S\+S\+E3 features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a6719853bee3dd03b8823540705a55932}\label{_s_d_l__cpuinfo_8h_a6719853bee3dd03b8823540705a55932}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has S\+S\+E4.\+1 features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a9fea35e1593bb7981cdc1da4d0b2dccb}\label{_s_d_l__cpuinfo_8h_a9fea35e1593bb7981cdc1da4d0b2dccb}} 
...
This function returns true if the \mbox{\hyperlink{class_c_p_u}{C\+PU}} has S\+S\+E4.\+2 features. \mbox{\Hypertarget{_s_d_l__cpuinfo_8h_a90747fee878a98aaba20e615f749308b}\label{_s_d_l__cpuinfo_8h_a90747fee878a98aaba20e615f749308b}} 
...
\subsubsection{\texorpdfstring{SDL\_SIMDAlloc()}{SDL\_SIMDAlloc()}}
...
\mbox{\hyperlink{_s_d_l__cpuinfo_8h_af533acf5c60f71bcefef0d8cea9dae99}{S\+D\+L\+\_\+\+S\+I\+M\+D\+Realloc}} 
...
\subsubsection{\texorpdfstring{SDL\_SIMDFree()}{SDL\_SIMDFree()}}
...
\subsubsection{\texorpdfstring{SDL\_SIMDGetAlignment()}{SDL\_SIMDGetAlignment()}}
...
\subsubsection{\texorpdfstring{SDL\_SIMDRealloc()}{SDL\_SIMDRealloc()}}
...
\begin{DoxyParams}{Parameters}
{\em mem} & The pointer obtained from S\+D\+L\+\_\+\+S\+I\+M\+D\+Alloc. This function also accepts N\+U\+LL, at which point this function is the same as calling S\+D\+L\+\_\+realloc with a N\+U\+LL pointer. \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Pointer to newly-\/reallocated block, N\+U\+LL if out of memory.
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
S\+D\+L\+\_\+\+S\+I\+M\+D\+Alignment 
