...
class ParameterWidget : public QWidget, public Object, public Identifiable {
    Q_OBJECT
public:
    //-----------------------------------------------------------------------------------------------------------------
    /// @name Static
...
public:
    ...
    JsonWidget(CoreEngine* core, Serializable* serializable, QWidget *parent = 0, bool init = false);
    virtual ~JsonWidget();
