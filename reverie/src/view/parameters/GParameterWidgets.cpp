...
// JsonWidget
///////////////////////////////////////////////////////////////////////////////////////////////////
JsonWidget::JsonWidget(CoreEngine* core, Serializable* serializable, QWidget *parent, bool init) :
    ParameterWidget(core, parent),
...
void JsonWidget::initializeWidgets()
{
    ...
    m_textEdit->setText(JsonReader::ToString<QString>(m_serializable->asJson(), true));
...
void JsonWidget::initializeConnections()
{
    ...
    connect(m_confirmButton, &QPushButton::clicked, this, [this](bool checked) {
        ...
        m_textEdit->setText(
            JsonReader::ToString<QString>(m_serializable->asJson(), true)
        );
