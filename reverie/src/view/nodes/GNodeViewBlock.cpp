...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::onSceneMouseMove(QGraphicsSceneMouseEvent* event)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::hoverEnterEvent(QGraphicsSceneHoverEvent * event)
{
    // Display only visible hover rect
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::hoverLeaveEvent(QGraphicsSceneHoverEvent * event)
{
    // Display only visible hover rect
    m_leftHoverRect->setVisible(false);
    m_rightHoverRect->setVisible(false);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::hoverMoveEvent(QGraphicsSceneHoverEvent * event)
{
    Q_UNUSED(event);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::createHoverRects()
{
    clearHoverRects();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void rev::View::NodeViewBlock::clearHoverRects()
{
    if (m_leftHoverRect) {
