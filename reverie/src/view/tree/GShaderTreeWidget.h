...
public:
    ...
    virtual const char* namespaceName() const override { return "rev::View:ShaderTreeItem"; }
...
public:
    ...
    virtual const char* namespaceName() const override { return "rev::View::ShaderTreeWidget"; }
