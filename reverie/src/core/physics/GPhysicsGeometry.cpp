...
// Physics Geometry
//////////////////////////////////////////////////////////////////////////////////////////////////
std::unique_ptr<PhysicsGeometry> PhysicsGeometry::CreateGeometry(const QJsonObject & json)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue PhysicsGeometry::asJson(const SerializationContext& context) const
{
    QJsonObject object;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue BoxGeometry::asJson(const SerializationContext& context) const
{
    QJsonObject object = PhysicsGeometry::asJson(context).toObject();
    object.insert("hx", hx());
    object.insert("hy", hy());
    object.insert("hz", hz());
...
//////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue SphereGeometry::asJson(const SerializationContext& context) const
{
    QJsonObject object = PhysicsGeometry::asJson(context).toObject();
...
//////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue PlaneGeometry::asJson(const SerializationContext& context) const
{
    QJsonObject object = PhysicsGeometry::asJson(context).toObject();
    return object;
}
