...
public:
    ...
    static std::unique_ptr<PhysicsGeometry> CreateGeometry(const QJsonObject& json);
    ...
    const char* namespaceName() const override { return "rev::PhysicsGeometry"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::BoxGeometry"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::SphereGeometry"; }
...
public:
    ...
    /// @property namespaceName
    const char* namespaceName() const override { return "rev::PlaneGeometry"; }
