...
#include "../rendering/lighting/GLight.h"
...
{
    return m_scene->engine()->mainRenderer()->renderContext().lightingSettings();
}
//////////////////////////////////////////////////////////////////////////////////////////////////
...
{
    RenderContext& context = m_scene->engine()->mainRenderer()->renderContext();
...
//////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue LightComponent::asJson(const SerializationContext& context) const
{
