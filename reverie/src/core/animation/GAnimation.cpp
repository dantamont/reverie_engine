...
#include "../animation/GBlendQueue.h"
...
// AnimationSettings
/////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue AnimationSettings::asJson(const SerializationContext& context) const
{
    QJsonObject object;
...
AnimationClip::AnimationClip(CoreEngine* engine, const QJsonValue & json):
    Nameable(json.toObject()["name"].toString())
{
...
//}
/////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue AnimationClip::asJson(const SerializationContext& context) const
{
    QJsonObject object;
