...
SkeletonJoint::SkeletonJoint() :
    Nameable("") // Give an empty name, to avoid nullptr when serializing
{
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
SkeletonJoint::~SkeletonJoint()
...
{
    return Flags<JointFlag>::toQFlags(m_jointFlags).testFlag(kIsAnimated);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void SkeletonJoint::setAnimated(bool animated)
{
    JointFlags flags = Flags<JointFlag>::toQFlags(m_jointFlags);
    ...
    m_inverseBindPose(other.m_inverseBindPose)
{
    ...
    std::vector<uint32_t> uninitializedNodes;
    uint32_t nodeSize = justBones ? m_boneNodes.size() : m_nodes.size();
...
{
    uint32_t size = m_boneNodes.size();
