...
{
    int offset = (int)CubeMapFace::kRight;
    return QDir::cleanPath(m_directoryPath + QDir::separator() + (const char*)m_fileNames.at((int)face - offset));
}
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
    auto handle = ResourceHandle::create(engine, ResourceType::kCubeTexture);
