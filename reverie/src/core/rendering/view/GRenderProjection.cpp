...
Matrix4x4 RenderProjection::Perspective(float fovDeg, float aspectRatio, float zNear, float zFar)
{
    ...
    double fovRad = rev::Constants::DEG_TO_RAD * fovDeg;
...
/////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue RenderProjection::asJson(const SerializationContext& context) const
{
    QJsonObject object;
