...
#include "../../rendering/materials/GTexture.h"
...
void FrameBuffer::drawQuad(Camera& camera, ShaderProgram& shaderProgram, size_t attachmentIndex)
{
    ...
    // Obtain quad
    Mesh* quad = core->resourceCache()->polygonCache()->getSquare();
    ...
    if (error) {
        logInfo("Error in Camera::drawFrameBufferQuad");
...
/////////////////////////////////////////////////////////////////////////////////////////////
void FrameBuffer::reinitialize(size_t w, size_t h, bool ignoreIncomplete)
{
    bind();
...
void FrameBuffer::bind() const
{
    ...
    if (m_currentContext != cc) {
        throw("Current context is not current");
    }

    bool error = gl.printGLError("Error, before binding FBO");
    if (error) {
        throw("Error before binding FBO");
    }
#endif
#endif
    ...
    if (error) {
        throw("Errorsetting draw buffers");
    }
#endif
#endif
}
...
/////////////////////////////////////////////////////////////////////////////////////////////
void FrameBuffer::clear(const Color & color, size_t attachmentIndex)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void FrameBuffer::blit(BlitMask mask, size_t readAttachmentIndex, const std::vector<size_t>& drawAttachmentIndices) const
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void FrameBuffer::blit(BlitMask blitMask, FrameBuffer & other, size_t colorAttachment) const
{
    blit(blitMask, other, colorAttachment, { colorAttachment });
}
/////////////////////////////////////////////////////////////////////////////////////////////
void FrameBuffer::blit(BlitMask blitMask, FrameBuffer & other, size_t readAttachmentIndex, const std::vector<size_t>& drawAttachmentIndices) const
{
