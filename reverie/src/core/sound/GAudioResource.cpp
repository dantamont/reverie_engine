...
// AudioSourceSettings
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue AudioSourceSettings::asJson(const SerializationContext& context) const
{
    QJsonObject object;
...
std::shared_ptr<ResourceHandle> AudioResource::CreateHandle(CoreEngine * engine, const GString & audioPath, SourceType sourceType)
{
    ...
    auto soundHandle = prot_make_shared<ResourceHandle>(engine,
        audioPath, ResourceType::kAudio);
    soundHandle->setName(FileReader::PathToName(audioPath.c_str()));
    soundHandle->setUsesJson(true);

    // Set handle attributes
    QJsonObject json;
    json.insert("sourceType", (int)sourceType);
    soundHandle->setResourceJson(json);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue AudioResource::asJson(const SerializationContext& context) const
{
    QJsonObject object;
