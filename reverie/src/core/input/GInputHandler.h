...
public:
    ...
    virtual const char* namespaceName() const override { return "rev::MouseHandler"; }
...
public:
    ...
    virtual const char* namespaceName() const override { return "rev::KeyHandler"; }
...
public:
    ...
    virtual const char* namespaceName() const override { return "rev::InputHandler"; }
