...
//#endif
    ...
    D distanceSquared(const Vector<D, N>& other) {
    ...
    D distance(const Vector<D, N>& other) {
        static_assert(N == 3 || N == 4, "Only vectors of length 3 or four supported");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Declare metatypes
Q_DECLARE_METATYPE(rev::Vector2f)
Q_DECLARE_METATYPE(rev::Vector3f)
Q_DECLARE_METATYPE(rev::Vector4f)
Q_DECLARE_METATYPE(rev::Vector2d)
Q_DECLARE_METATYPE(rev::Vector3d)
Q_DECLARE_METATYPE(rev::Vector4d)
