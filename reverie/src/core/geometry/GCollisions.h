...
struct AABBData {
    ...
    bool isInitialized() const{
        return m_min.x() != std::numeric_limits<real_g>::infinity();
    }
...
public:
    ...
    void transformBounds(const Transform& transform, BoundingGeometry<G>& transformedGeomtry) const;

    /// @brief Transform the bounding geometry, and append to specified geometry
    void addTransformedBounds(const Transform& transform, BoundingGeometry<G>& transformedGeometry) const;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
template<typename G>
inline void BoundingGeometry<G>::transformBounds(const Transform & transform, BoundingGeometry<G>& transformedGeometry) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////
template<typename G>
inline void BoundingGeometry<G>::addTransformedBounds(const Transform & transform, BoundingGeometry<G>& transformedGeometry) const
{
