...
class CoreEngine: public QObject, public rev::Object, public Identifiable {
    Q_OBJECT
public:
    ...
    virtual const char* namespaceName() const { return "rev::CoreEngine"; }
    /// @}
...
// Typedef
///////////////////////////////////////////////////////////////////////////////////////////////////
typedef rev::CoreEngine GbEngine;
