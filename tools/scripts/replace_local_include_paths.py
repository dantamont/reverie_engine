# This script updates includes for headers that were originally in the same folder as source to have a path relative to the include directory
...
#        print(root, dir_names, filenames)
        ...
        for filename in filenames:
            ...
            if filename.startswith("G") and filename.endswith(".cpp"):
                match_count = 0
