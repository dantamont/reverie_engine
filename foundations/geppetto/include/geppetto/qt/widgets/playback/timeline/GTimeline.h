...
public:
    ...
    explicit Timeline(bool setTickLabels, QObject *parent = nullptr);
    ~Timeline();
    ...
    size_t addRow(const QString& name, bool refreshTicks = true);
...
private:
    ...
    void onResizeRowHeaders(qreal size, bool refreshTicks);
