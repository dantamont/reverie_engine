...
class BaseAnimationState : public Object, public Serializable {
public:
    //---------------------------------------------------------------------------------------
    ...
    bool connectsFrom(const BaseAnimationState* state, AnimationStateMachine* sm, int* outConnectionIndex = nullptr);

    /// @brief Whether or not the connection ends at the given state
    bool connectsTo(const BaseAnimationState* state, AnimationStateMachine* sm, int* outConnectionIndex = nullptr);
    ...
    virtual const char* namespaceName() const { return "Gb::BaseAnimationState"; }
