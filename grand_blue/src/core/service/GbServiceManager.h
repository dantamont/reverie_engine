...
public:
    ...
    const char* namespaceName() { return "Gb::DeferredConnection"; }
    /// @}
...
*/
class ServiceManager: public QObject, public Gb::Object {
    Q_OBJECT
...
public:
    ...
    const char* namespaceName() { return "Gb::View::ServiceManager"; }
    /// @}
    //-----------------------------------------------------------------------------------------------------------------
    /// @name Static Methods
    /// @{
