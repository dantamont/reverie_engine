...
void SoundManager::setListener(AudioListenerComponent * listener)
{
    if (m_listener && listener) {
        throw("Error, only one listener may exist at a time");
    }
...
void SoundManager::removeSource(AudioSourceComponent * source)
{
    ...
    if (iter == m_sourceComponents.end()) {
        logError("Error, source component not found for deletion");
        throw("oopsie poopsie");
    }
...
void SoundManager::audioThreadCallback() {
    //SoLoud::Wav wave;
    //wave.setLooping(1);
    //int errorCode = wave.load("C:/Users/dante/Music/looking_up.mp3");
...
/////////////////////////////////////////////////////////////////////////////////////////////
QJsonValue SoundManager::asJson() const
{
    return QJsonValue();
}
/////////////////////////////////////////////////////////////////////////////////////////////
void SoundManager::loadFromJson(const QJsonValue & json, const SerializationContext & context)
{
}
