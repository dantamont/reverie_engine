#include "GbAnimationClipWidget.h"
#include "../../style/GbFontIcon.h"

#include "../../../core/animation/GbAnimation.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Animation> AnimClipWidget::getAnimation() const
{
    auto handle = m_clip->animationHandle();
